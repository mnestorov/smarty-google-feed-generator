...
class Smarty_Gfg_Locator {
	...
	private function define_admin_hooks() {
    	...
    	$this->loader->add_action('woocommerce_update_product', $plugin_admin, 'invalidate_feed_cache');
		$this->loader->add_action('before_delete_post', $plugin_admin, 'invalidate_feed_cache_on_delete');
		$this->loader->add_action('comment_post', $plugin_admin, 'invalidate_review_feed_cache', 10, 2);
		$this->loader->add_action('edit_comment', $plugin_admin, 'invalidate_review_feed_cache');
    	$this->loader->add_action('deleted_comment', $plugin_admin, 'invalidate_review_feed_cache');
    	$this->loader->add_action('wp_set_comment_status', $plugin_admin, 'invalidate_review_feed_cache');
		$this->loader->add_action('save_post_product', $plugin_admin, 'handle_product_change');
		$this->loader->add_action('deleted_post', $plugin_admin, 'handle_product_change');
